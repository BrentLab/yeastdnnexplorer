...
class And(Relation):
    """
    Class for representing the logical AND of multiple conditions
    Allows nesed conditions, i.e. And(1, Or(2, 3))
    """
...
# "index 2 should only have its score adjusted if it is activated and if (index 5 and 7) or 3 is activated"
condition = And(
