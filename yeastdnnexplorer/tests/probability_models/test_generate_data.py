...
def test_generate_binding_effects_success():
    ...
    # Create a mock GenePopulation with some genes labeled as signal and others as noise
...
def test_generate_perturbation_effects_with_and_without_adjustment():
    torch.manual_seed(42)
    # Create mock binding data with the first column indicating signal (1) or noise (0),
